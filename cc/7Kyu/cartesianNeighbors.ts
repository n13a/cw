...
distances to the point from two fixed perpendicular directed lines, measured 
...
y-axis and returns a list of all the neighboring points. Points inside your 
returned list need not be sorted (any order is valid).
